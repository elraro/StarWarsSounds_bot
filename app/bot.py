...
LOG = logger.get_logger('StarWarsSoundsBot')
...
parser.add_argument("-b", "--bucket", help="Bucket or url where audios are stored",
                    default='https://raw.githubusercontent.com/elraro/StarWarsSounds_bot/main/StarWarsSounds/')
...
if args.mysql_host:
    ...
    database = Database('mysql', host=args.mysql_host, port=args.mysql_port, user="bot", password="bot", database_name="bot")
else:
